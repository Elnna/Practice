        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" value="<?php echo ($news["description"]); ?>" class="form-control" name="description" id="inputPassword3" placeholder="描述">
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">关键字:</label>
              <div class="col-sm-5">
                <input type="text" value="<?php echo ($news["keywords"]); ?>" class="form-control" name="keywords" id="inputPassword3" placeholder="请填写关键词">
              </div>
            </div>

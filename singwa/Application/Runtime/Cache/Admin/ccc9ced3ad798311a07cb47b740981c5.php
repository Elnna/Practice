...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/vgm-news/Public/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/vgm-news/Public/css/sb-admin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="/vgm-news/Public/css/plugins/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="/vgm-news/Public/css/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="/vgm-news/Public/css/sing/common.css" />
    <link rel="stylesheet" href="/vgm-news/Public/css/party/bootstrap-switch.css" />
    <link rel="stylesheet" type="text/css" href="/vgm-news/Public/css/party/uploadify.css">

    <!-- jQuery -->
    <script src="/vgm-news/Public/js/jquery.js"></script>
    <script src="/vgm-news/Public/js/bootstrap.min.js"></script>
    <script src="/vgm-news/Public/js/dialog/layer.js"></script>
    <script src="/vgm-news/Public/js/dialog.js"></script>
    <script type="text/javascript" src="/vgm-news/Public/js/party/jquery.uploadify.js"></script>
    ...
    <div class="container-fluid" >
      ...
      <div class="row">
        <form action="/admin.php" method="get">
          ...
          <div class="col-md-3">
            <div class="input-group">
              <input class="form-control" name="title" type="text" value="<?php echo ($contentTitle); ?>" placeholder="文章标题" />
          ...
          <div class="table-responsive">
            ...
            <div class="input-group">
                <select class="form-control" name="position_id" id="select-push">
                    <option value="0">请选择推荐位 进行推送</option>
...
<script src="/vgm-news/Public/js/admin/common.js"></script>

                ...
                <div class="span4 box">
                    <div class="content-wrap">
                        <h6>慕课商城 - 修改密码</h6>
                            ...
                            <?php echo $form->field($model,'admin_password')->passwordInput(['class'=>'span12','placeholder' => '新密码']); ?>
                            <?php echo $form->field($model,'repwd')->passwordInput(['class'=>'span12','placeholder' => '确认密码']); ?>
